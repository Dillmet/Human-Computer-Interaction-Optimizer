...
with st.sidebar:
    ...
    # Add password input if accessing restricted pages
    if selected in ['Text to Sign', 'Sign to Text', 'Help']:
...
# Add password check before executing restricted functionality
def speech_to_text():
